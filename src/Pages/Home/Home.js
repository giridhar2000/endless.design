      ...
      <div className="homePage">
        <div className="intro">
          ...
          <div className="introText animate">
            ...
            <p>
              <span style={{ color: "black" }}>TMBC makes</span>
              <Typewriter
                options={{
        ...
        <div className="homeContent">
          ...
          <div className="branding">
            <Fade top>
              <h2>We only design you what we're exceptionally good at.</h2>
            </Fade>
            <br />
            <p>
              We want to leave no room for disappointment, so we don't waste
              time designing things we aren't good at, we only design what we
              excel at.
            </p>
              ...
              <Slide left>
                <div className="brandworks">
                  <span className="worklist">
                    <BorderOutlined /> &nbsp;Branding
                  </span>
                  <span className="worklist">
                    <StarOutlined /> &nbsp;Design Systems
                  </span>
                  <span className="worklist">
                    <CreditCardOutlined /> &nbsp;Landing Pages
                  </span>
                </div>
              </Slide>
              <Slide right>
                <div className="brandworks">
                  <span className="worklist">
                    <MobileOutlined /> &nbsp;Short form video
                  </span>
                  <span className="worklist">
                    <DesktopOutlined /> &nbsp;Web Apps
                  </span>
                  <span className="worklist">
                    <DeploymentUnitOutlined /> &nbsp;Explainers
                  </span>
                </div>
              </Slide>
            </div>
            ...
            <div className="work">
              ...
              <p>
                After subscribing, you and your team will be invited to an
                exclusive Slack/Telegram/Twist channel to collaborate with us
                directly. From here, you can chat to us 1:1 and submit as many
                design requests as you like.
              </p>
              <p>
                We'll close each of them off one by one and make as many
            ...
            <div className="notification">
              <div className="notifyHead">
                ...
                />{" "}
                &nbsp;You subscribed to Endless
              </div>
              <Divider style={{ margin: "5px auto" }} />
              <div className="notifyBody">Acme, welcome to Endless.</div>
            </div>
            ...
            <img
              src={screenshot}
              alt="logo"
              style={{ marginTop: "5vh", borderRadius: "2vh", width: "100%" }}
            />
          ...
          <div className="pricing">
            ...
            <div className="workflow">
              <div>
                <OneToOneOutlined style={{ marginBottom: "2vh" }} />
                <br />
                <p>
                  Unlimited design requests and revisions. Get the perfect
                  design.
                </p>
              </div>

              <div>
                <HistoryOutlined style={{ marginBottom: "2vh" }} />
                <br />
                <p>
                  {" "}
                  Receive designs in 2-3 days on average. Make unlimited
                  changes.
                </p>
              </div>

              <div>
                <SlackOutlined style={{ marginBottom: "2vh" }} />
                <br />
                <p>
                  1:1 communication with a designer via a private Slack channel.
                </p>
              </div>

              <div>
                <WechatOutlined style={{ marginBottom: "2vh" }} />
                <br />
                <p>
                  Everything is async. No calls or meetings to fill your
                  calendar.
                </p>
              </div>
            </div>
            ...
            <div className="faq">
              ...
              <Collapse
                ...
                body={
                  "For simpler requests, you will receive a first draft in 2 buisness days, but some designs tasks can be incredibly complex and take longer."
                }
              />
              ...
              <Collapse
                ...
                body={
                  "We prefer to keep communication async with Slack, Loom or even email. this is what helps us to be so efficient."
                }
              />
              ...
              <Collapse
                ...
                body={
                  "Not a problem. We'll make endless revision to your design until you're 100% satisfied with the result."
                }
              />
              ...
              <Collapse
                ...
                body={
                  "No, there are no limits to the amount of design requests you can make. Make as many as you want, each will be completed one by one."
                }
              />
              ...
              <Collapse
                ...
                body={
                  "When signing up, you will receive a welcome email. This email will also contain a link to log into your customer portal where you wil be able to manager your subscription."
                }
              />
